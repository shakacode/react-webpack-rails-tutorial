...
preserve the customized validator and review changes to each cohort separately.
Follow the canonical [split-migration guidance](../.controlplane/docs/testing-cpflow-github-actions.md#released-review-app-pair)
when upgrading either cohort.
